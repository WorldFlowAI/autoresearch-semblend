...
Qwen2.5-7B @ 8K tokens (A10G) & 3{,}495 & $n{=}5$, per-length restart \\
Qwen2.5-7B @ 16K tokens (A10G) & 6{,}657 & $n{=}5$, per-length restart \\
LLaMA-3.1-8B @ 8K tokens (A10G) & 3{,}425 & $n{=}5$, per-length restart \\
LLaMA-3.1-8B @ 16K tokens (A10G) & 7{,}286 & $n{=}5$, per-length restart \\
\bottomrule
\end{tabular}\\[2pt]
