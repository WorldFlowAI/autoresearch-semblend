...
an 8-worker fleet (\S\ref{sec:scaled}), achieving 100\% semantic routing
and $2.4$--$3.8\times$ speedup; empirical per-instance isolation is
confounded by vLLM's internal RadixAttention prefix cache.
