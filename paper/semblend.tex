...
pairs, PPL ratio was $1.000 \pm 0.001$---indistinguishable from cold
...
worse quality than the cold baseline. The non-monotonic hit-rate
pattern in Figure~\ref{fig:variation-sensitivity}(b) confirms that
...
CNN/DailyMail 8K, Qwen2.5-7B-AWQ, $n{=}8$ per type.}
