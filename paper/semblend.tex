...
a problem orthogonal to \semblend's cross-request donor reuse. KVLink~\cite{kvlink} precomputes
...
This architecture-aware selection is independently validated by
our per-layer K-norm deviation measurements: with RoPE correction,
all-layer deviation is ${<}0.2\%$ for both models, confirming
the bathtub-selected layers are the right recomputation targets.
