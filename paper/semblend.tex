...
\emph{Hit rate stability.} At 2K CNN/DailyMail tokens, hit rate
remains \textbf{100\%} and TTFT speedup stays $3.6$--$3.7\times$
for all pool sizes from 1 to 50 donors ($n{=}8$ queries per size):
...
\midrule
1  & 100\% & $3.63\times$ & $3.63\times$ \\
8  & 100\% & $3.61\times$ & $3.61\times$ \\
32 & 100\% & $3.71\times$ & $3.71\times$ \\
50 & 100\% & $3.71\times$ & $3.71\times$ \\
\bottomrule
\end{tabular}
\end{center}
...
At 2K tokens, no eviction occurs and speedup is strictly non-decreasing
with pool size.
...
SemBlend for semantic variants; and
