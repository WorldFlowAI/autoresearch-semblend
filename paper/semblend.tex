...
\item \textbf{Empirical evaluation} on two model architectures
  ...
  2K--16K tokens with quality preserved (PPL ratio ${\leq}1.065$ on
...
consistently achieve PPL ${\leq}1.065$.
...
our 1.08 quality ceiling (set conservatively above the 1.065 maximum observed
on high-hit datasets). Similarity $\geq 0.60$ achieves 62\% hit rate with PPL
