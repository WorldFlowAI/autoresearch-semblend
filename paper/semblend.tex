...
not by KV injection quality. Qwen tested on 5 datasets,
LLaMA on 4 (MultiNews pending). $n{=}8$ per length.}
...
$^\dagger$MultiNews@8K mean 1.119 is driven by 1/8 miss run (PPL=1.90);
hit-only PPL = 1.007.
