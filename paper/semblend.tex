...
natural sentence boundary. Non-collapsing hits achieve ROUGE-L
${\approx}0.85$--$1.0$ with PPL ratio 1.048 (vs.\ 1.025 at
\texttt{max\_tokens=256}), indicating the PPL metric remains
stable; the EOS-collapse issue is visible only through
output-length monitoring. A minimum-output-length constraint or
instruction-based prompting (``Continue writing:'') eliminates
this artifact and is recommended for production deployments.
