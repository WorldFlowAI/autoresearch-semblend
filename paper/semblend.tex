...
& 16K tokens & 6,377 &  824 & $7.74\times^\dagger$  &  60\% & 5 \\
\bottomrule
\end{tabular}\\[2pt]
...
$^\dagger$Hit-only speedup; LLaMA 16K hit rate limited by LMCache CPU buffer
...
Peak individual: $11.97\times$ (Qwen 32K).}
\end{table*}
...
at 16K, cold prefill takes 6.6\,s while SemBlend completes in 0.79\,s;
at 32K, cold prefill reaches 15.4\,s while SemBlend completes in 1.3\,s
($12\times$ speedup). SemShareKV tested only at 5K tokens and does not
...
$\mathbf{8.3\times}$ at 16K and $\mathbf{11.97\times}$ at 32K tokens
(peak individual) across Qwen2.5-7B-AWQ and LLaMA-3.1-8B-AWQ on
