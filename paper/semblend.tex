...
XSum-synthetic and WikiHow confirm PPL $\leq 1.065$ on high-hit datasets.
SAMSum and CNN/DM-LLaMA show elevated PPL due to miss-run outliers, not
KV injection degradation. Hit rate is the primary predictor of mean PPL.}
\end{table}
