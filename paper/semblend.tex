...
We validate correctness with 125 unit tests including mathematical exactness
...
P50 speedup at 16K: $7.77\times$ (Qwen), $8.26\times$ (LLaMA).
Peak individual: $8.71\times$ (Qwen 16K, $857$\,ms vs.\ $6{,}657$\,ms cold).}
\end{table*}
...
and unit-tested (125 tests total, all passing). Integration with vLLM's
