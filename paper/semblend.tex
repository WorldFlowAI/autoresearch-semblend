...
confirms identical results: NoPE PPL ratio $= 1.000{\pm}0.002$
vs.\ delta $1.000{\pm}0.001$; TTFT speedup $1.95\times$ NoPE
vs.\ $1.97\times$ delta (XSum 8K, $n{=}8$).
The difference is within measurement noise, confirming mathematical
equivalence. We release NoPE as an optional validated mode for
environments that prefer position-free storage.
