...
\midrule
\multirow{9}{*}{\shortstack[l]{Qwen2.5-7B\\(28L, 4 KV)}}
...
\midrule
\multirow{9}{*}{\shortstack[l]{LLaMA-3.1-8B\\(32L, 8 KV)}}
...
($2.66$--$3.34\times$) than Qwen ($1.51$--$2.29\times$) across all three
datasets. WikiHow achieves 100\% hit rate on both models, confirming
structured procedural text benefits most from SemBlend. LLaMA's advantage
is architecture-driven: 32 layers vs 28 increases cold prefill cost while
SemBlend's KV transfer overhead remains constant.}
\end{table}
